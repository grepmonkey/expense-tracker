...
This privacy policy applies to the Expense Tracker app (hereby referred to as "Application") for mobile devices that was created by grepmonkey (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
